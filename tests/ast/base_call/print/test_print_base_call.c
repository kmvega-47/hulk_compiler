...
void test_print_base_call_no_args(void)
{
    printf("\n\n------------ Inicio test: test_print_base_call_no_args ------------\n");
    global_tables_init();
...
void test_print_base_call_with_args(void)
{
    printf("\n\n------------ Inicio test: test_print_base_call_with_args ------------\n");
    global_tables_init();
...
int main(void)
{
    printf("\n=== Iniciando tests de BaseCallNode (print) ===\n");

    if (CUE_SUCCESS != CU_initialize_registry())
        return CU_get_error();

    CU_pSuite suite = CU_add_suite("BaseCallNode Print Tests", NULL, NULL);
    if (!suite)
    {
        CU_cleanup_registry();
        return CU_get_error();
    ...
    CU_add_test(suite, "test_print_base_call_no_args", test_print_base_call_no_args);
    CU_add_test(suite, "test_print_base_call_with_args", test_print_base_call_with_args);
