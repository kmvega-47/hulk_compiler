...
typedef enum
{
    NODE_LITERAL, NODE_UNARY_OPERATION, NODE_BINARY_OPERATION, NODE_EXPRESSION_BLOCK, NODE_CONDITIONAL, NODE_WHILE_LOOP,
    NODE_LET_IN, NODE_VARIABLE_REFERENCE, NODE_REASSIGNMENT,
    NODE_FUNCTION_DEFINITION, NODE_FUNCTION_CALL,
    NODE_TYPE_DEFINITION, NODE_ATTRIBUTE_ACCESS, NODE_METHOD_ACCESS, NODE_TYPE_INSTANCIATION,
    NODE_BASE_CALL, NODE_IS, NODE_AS,
    NODE_PROGRAM
} ASTNodeType;
