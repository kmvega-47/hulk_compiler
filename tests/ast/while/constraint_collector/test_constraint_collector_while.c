...
void test_collector_while_as_condition(void)
{
    printf("\n\n------------ Inicio test: test_collector_while_as_condition ------------\n");
    dm_global = dm_create();
    global_tables_init();

    printf("Caso: function f(x) => while(x) 1;\n");
    ...
    ASTNode *x_ref = (ASTNode *)ast_variable_reference_create("x", 1, 28);
    ASTNode *one = (ASTNode *)ast_number_literal_create(1.0, 1, 33);
    ASTNode *body = (ASTNode *)ast_while_create(x_ref, one, 1, 20);
...
void test_collector_while_at_body(void)
{
    printf("\n\n------------ Inicio test: test_collector_while_at_body ------------\n");
    dm_global = dm_create();
    global_tables_init();

    printf("Caso: function f(x) => while(true) -x;\n");

    List *params = list_create(0, NULL, (free_func)symbol_binding_destroy, NULL, NULL);
    list_append(params, symbol_binding_create("x", NULL, NULL, 1, 13));

    ASTNode *x_ref = (ASTNode *)ast_variable_reference_create("x", 1, 35);
    ASTNode *neg = (ASTNode *)ast_unary_create(OP_SUB, x_ref, 1, 34);
    ASTNode *cond_true = (ASTNode *)ast_bool_literal_create(true, 1, 25);
    ASTNode *body = (ASTNode *)ast_while_create(cond_true, neg, 1, 20);
    FunctionDefinitionNode *f = ast_function_definition_create("f", params, NULL, body, 1, 1);
...
void test_collector_while_multiple_params(void)
{
    printf("\n\n------------ Inicio test: test_collector_while_multiple_params ------------\n");
    dm_global = dm_create();
    global_tables_init();

    printf("Caso: function f(x, y) => while(x) -y;\n");

    List *params = list_create(0, NULL, (free_func)symbol_binding_destroy, NULL, NULL);
    list_append(params, symbol_binding_create("x", NULL, NULL, 1, 13));
    list_append(params, symbol_binding_create("y", NULL, NULL, 1, 16));

    ASTNode *x_cond = (ASTNode *)ast_variable_reference_create("x", 1, 30);
    ASTNode *y_ref = (ASTNode *)ast_variable_reference_create("y", 1, 35);
    ASTNode *neg = (ASTNode *)ast_unary_create(OP_SUB, y_ref, 1, 34);
    ASTNode *body = (ASTNode *)ast_while_create(x_cond, neg, 1, 20);
    FunctionDefinitionNode *f = ast_function_definition_create("f", params, NULL, body, 1, 1);
...
void test_collector_while_type_init_param(void)
{
    printf("\n\n------------ Inicio test: test_collector_while_type_init_param ------------\n");
    dm_global = dm_create();
    global_tables_init();

    printf("Caso: type Point(x) { x = while(true) -x; }\n");
    ...
    ASTNode *neg = (ASTNode *)ast_unary_create(OP_SUB, x_ref, 1, 41);
    ASTNode *cond_true = (ASTNode *)ast_bool_literal_create(true, 1, 30);
    ASTNode *x_init = (ASTNode *)ast_while_create(cond_true, neg, 1, 28);
...
void test_collector_while_method_param(void)
{
    printf("\n\n------------ Inicio test: test_collector_while_method_param ------------\n");
    dm_global = dm_create();
    global_tables_init();

    printf("Caso: type A { f(x) => while(true) !x; }\n");
    ...
    ASTNode *cond_true = (ASTNode *)ast_bool_literal_create(true, 1, 40);
    ASTNode *x_ref = (ASTNode *)ast_variable_reference_create("x", 1, 48);
    ASTNode *not_x = (ASTNode *)ast_unary_create(OP_NOT, x_ref, 1, 47);
    ASTNode *m_body = (ASTNode *)ast_while_create(cond_true, not_x, 1, 36);
...
int main(void)
{
    printf("\n=== Iniciando tests de ConstraintCollector (while) ===\n");

    if (CUE_SUCCESS != CU_initialize_registry())
        return CU_get_error();

    CU_pSuite suite = CU_add_suite("ConstraintCollector While Tests", NULL, NULL);
    if (!suite)
    {
        CU_cleanup_registry();
        return CU_get_error();
    ...
    CU_add_test(suite, "test_collector_while_as_condition", test_collector_while_as_condition);
    CU_add_test(suite, "test_collector_while_at_body", test_collector_while_at_body);
    CU_add_test(suite, "test_collector_while_multiple_params", test_collector_while_multiple_params);
    CU_add_test(suite, "test_collector_while_type_init_param", test_collector_while_type_init_param);
    CU_add_test(suite, "test_collector_while_method_param", test_collector_while_method_param);
