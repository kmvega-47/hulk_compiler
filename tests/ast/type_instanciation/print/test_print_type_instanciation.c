...
void test_print_type_instanciation_no_args(void)
{
    printf("\n\n------------ Inicio test: test_print_type_instanciation_no_args ------------\n");
    global_tables_init();
...
void test_print_type_instanciation_multiple_args(void)
{
    printf("\n\n------------ Inicio test: test_print_type_instanciation_multiple_args ------------\n");
    global_tables_init();
...
void test_print_type_instanciation_long_name(void)
{
    printf("\n\n------------ Inicio test: test_print_type_instanciation_long_name ------------\n");
    global_tables_init();
...
int main(void)
{
    printf("\n=== Iniciando tests de TypeInstanciationNode (print) ===\n");

    if (CUE_SUCCESS != CU_initialize_registry())
        return CU_get_error();

    CU_pSuite suite = CU_add_suite("TypeInstanciationNode Print Tests", NULL, NULL);
    if (!suite)
    {
        CU_cleanup_registry();
        return CU_get_error();
    ...
    CU_add_test(suite, "test_print_type_instanciation_no_args", test_print_type_instanciation_no_args);
    CU_add_test(suite, "test_print_type_instanciation_multiple_args", test_print_type_instanciation_multiple_args);
    CU_add_test(suite, "test_print_type_instanciation_long_name", test_print_type_instanciation_long_name);
