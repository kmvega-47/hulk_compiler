...
void test_print_method_access_no_args(void)
{
    printf("\n\n------------ Inicio test: test_print_method_access_no_args ------------\n");
    global_tables_init();
...
void test_print_method_access_with_args(void)
{
    printf("\n\n------------ Inicio test: test_print_method_access_with_args ------------\n");
    global_tables_init();
...
int main(void)
{
    printf("\n=== Iniciando tests de MethodAccessNode (print) ===\n");

    if (CUE_SUCCESS != CU_initialize_registry())
        return CU_get_error();

    CU_pSuite suite = CU_add_suite("MethodAccessNode Print Tests", NULL, NULL);
    if (!suite)
    {
        CU_cleanup_registry();
        return CU_get_error();
    ...
    CU_add_test(suite, "test_print_method_access_no_args", test_print_method_access_no_args);
    CU_add_test(suite, "test_print_method_access_with_args", test_print_method_access_with_args);
